...
<html>
    ...
    <center><h1>Formulario de Registro</h1></center>
        <form action="usuario" method="post">
            ...
            <label>Usuario</label>
            <input type="text" name="usuarioPersona" placeholder="Digite su usuario" style="text-align: center"><br>
            <label>Contraseña</label>
           <input type="password" name="passwordPersona" placeholder="Digite su contraseña" style="text-align: center"><br>
            <label>Rol persona</label>
           <input type="text" name="rolPersona" placeholder="Digite el rol" style="text-align: center"><br>
